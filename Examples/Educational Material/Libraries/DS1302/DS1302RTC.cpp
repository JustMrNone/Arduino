...
//============================================================================================================//|
//                                                                                                            //|
//                                DS1302RTCClass Functions Begin                                        //|
//                                                                                                            //|
//============================================================================================================//|
//=======================================================================================================//|    |
//                                                                                                       //|    |
//                                      DS1302RTCFunction Begin                                    //|    |
//                                                                                                       //|    |
//=======================================================================================================//|    |
//                                                                                                       //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
DS1302RTC::DS1302RTC(uint8_t inSCLK, uint8_t inIO, uint8_t inC_E)   {                          //|    |
  SCLK = inSCLK;                                                                                         //|    |
  IO = inIO;                                                                                             //|    |
  C_E = inC_E;                                                                                           //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
void DS1302RTC::DS1302_clock_burst_read( uint8_t *p)  {                                             //|    |
  int i;                                                                                                 //|    |
  _DS1302_start();                                                                                       //|    |
                                                                                                         //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
void DS1302RTC::DS1302_clock_burst_write( uint8_t *p)  {                                            //|    |
  int i;                                                                                                 //|    |
  _DS1302_start();                                                                                       //|    |
                                                                                                         //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
uint8_t DS1302RTC::DS1302_read(int address)  {                                                      //|    |
  uint8_t data;                                                                                          //|    |
                                                                                                         //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
void DS1302RTC::DS1302_write( int address, uint8_t data)  {                                         //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
void DS1302RTC::_DS1302_start( void )  {                                                            //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
void DS1302RTC::_DS1302_stop( void )  {                                                             //|    |
  // Set CE low                                                                                          //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
uint8_t DS1302RTC::_DS1302_toggleread( void )  {                                                    //|    |
  uint8_t i, data;                                                                                       //|    |
  data = 0;                                                                                              //|    |
                                                                                                         //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
void DS1302RTC::_DS1302_togglewrite( uint8_t data, uint8_t release)  {                              //|    |
  int i;                                                                                                 //|    |
                                                                                                         //|    |
  for( i = 0; i <= 7; i++ )  {                                                                           //|    |
...
//                                                                                                       //|    |
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//|    |
void DS1302RTC::setDS1302Time(uint8_t seconds, uint8_t minutes, uint8_t hours, uint8_t dayofweek,   //|    |
